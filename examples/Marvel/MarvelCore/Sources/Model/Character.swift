...
public struct Character: Identifiable {
	...
	public static let ironman = Character(
		...
		image: URL(string: "http://i.annihil.us/u/prod/marvel/i/mg/9/c0/527bb7b37ff55/standard_fantastic.jpg")!, 
		comics: []
	)
	...
	public static let wolverine = Character(
		...
		image: URL(string: "http://i.annihil.us/u/prod/marvel/i/mg/2/60/537bcaef0f6cf/standard_fantastic.jpg")!, 
		comics: []
	)
	...
	public static let spiderman = Character(
		...
		image: URL(string: "http://i.annihil.us/u/prod/marvel/i/mg/3/50/526548a343e4b/standard_fantastic.jpg")!,
		comics: []
	)
}
