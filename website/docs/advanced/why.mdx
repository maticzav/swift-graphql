...
There are two big reasons why you should choose SwiftGraphQL. The first section outlines why you should consider using `SwiftGraphQL` in your project and the second one explains why we think it's the best Swift GraphQL client.
