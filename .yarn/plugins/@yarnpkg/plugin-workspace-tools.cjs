      ...
      var e = {
          997: (e, t, n) => {
            ...
            function o(e, t, n, o) {
              ...
              else for (var i = e.length - 1; i >= 0; i--) (r = e[i]) && (s = (a < 3 ? r(s) : a > 3 ? r(t, n, s) : r(t, n)) || s)
            ...
            ;(l.usage = s.Command.Usage({
              ...
              o([s.Command.Boolean('-A,--all', { description: 'Install the entire project' })], l.prototype, 'all', void 0),
              ...
              async execute() {
                ...
                for (const e of A)
                  (!u || e.manifest.scripts.has(u) || u.includes(':')) &&
                    ((u === process.env.npm_lifecycle_event && e.cwd === o.cwd) ||
                      (this.include.length > 0 && !p().isMatch(a.structUtils.stringifyIdent(e.locator), this.include)) ||
                ...
                const S = await a.StreamReport.start({ configuration: t, stdout: this.context.stdout }, async (e) => {
                  const o = async (n, { commandIndex: o }) => {
                    ...
                    try {
                      const t = (await this.cli.run([this.commandName, ...this.args], { cwd: n.cwd, stdout: s, stderr: l })) || 0
                      s.end(), l.end()
                      const o = await i,
                        a = await u
                      return (
                        this.verbose && o && a && e.reportInfo(null, `${r} Process exited without output (exit code ${t})`),
                        130 === t && ((w = !0), (x = t)),
                        t
                      )
                    } catch (e) {
          ...
          235: (e, t, n) => {
            ...
            ;(i.parse = (e, t = {}) => s(e, t)),
              ...
              (i.create = (e, t = {}) => ('' === e || e.length < 3 ? [e] : !0 !== t.expand ? i.compile(e, t) : i.expand(e, t))),
              (e.exports = i)
          },
          617: (e, t, n) => {
            const o = n(169),
          ...
          425: (e, t, n) => {
            ...
            e.exports = (e, t = {}) => {
              ...
              const T = () => e[S++],
                k = (e) => {
                  if (('text' === e.type && 'dot' === v.type && (v.type = 'text'), !v || 'text' !== v.type || 'text' !== e.type))
          ...
          542: (e, t) => {
            ;(t.isInteger = (e) =>
              ...
              (t.encloseBrace = (e) => 'brace' === e.type && (e.commas >> (0 + e.ranges)) >> 0 == 0 && ((e.invalid = !0), !0)),
              (t.isInvalidBrace = (e) =>
                'brace' === e.type &&
                (!(!0 !== e.invalid && !e.dollar) ||
                  (((e.commas >> (0 + e.ranges)) >> 0 == 0 || !0 !== e.open || !0 !== e.close) && ((e.invalid = !0), !0)))),
              (t.isOpenOrClose = (e) => 'open' === e.type || 'close' === e.type || !0 === e.open || !0 === e.close),
              (t.reduce = (e) =>
                e.reduce((e, t) => ('text' === t.type && e.push(t.value), 'range' === t.type && (t.type = 'text'), e), [])),
              (t.flatten = (...e) => {
                const t = [],
                  n = (e) => {
            ...
            const o = n(669),
              ...
              g = (e, t, n = 1, o = {}) => {
                ...
                let A = l(i) || l(h) || l(g),
                  ...
                  R =
                    !1 === A && !1 === ((e, t, n) => 'string' == typeof e || 'string' == typeof t || !0 === n.stringify)(e, t, o),
                  m =
                    o.transform ||
                    (
                      (e) => (t) =>
          ...
          578: (e, t, n) => {
            const o = n(550),
              r = (e) => {
                ...
                return Object.defineProperties(s, { activeCount: { get: () => n }, pendingCount: { get: () => t.length } }), s
              }
            ...
            const o = n(86),
              ...
              d = (e, t) => {
                ...
                for (; !j(); ) {
                  ...
                  if ('{' === U && !0 !== n.nobrace) {
                    Z('braces')
                    const e = { type: 'brace', value: U, output: '(', outputIndex: B.output.length, tokensIndex: B.tokens.length }
                    P.push(e), z(e)
                    continue
                  }
                  if ('}' === U) {
                  ...
                  if (',' === U) {
                    ...
                    t && 'braces' === D[D.length - 1] && ((t.comma = !0), (e = '|')), z({ type: 'comma', value: U, output: e })
                    continue
                  }
                  if ('/' === U) {
                  ...
                  if (G && ('globstar' === G.type || !0 === G.star)) {
                    ;(G.type = 'star'), (G.star = !0), (G.value += U), (G.output = I), (B.backtrack = !0), (B.globstar = !0), Q(U)
                    continue
                  }
                  let t = W()
                  ...
                  if ('star' === G.type) {
                    ...
                    if ('bos' === o.type && j()) {
                      ;(G.type = 'globstar'), (G.value += U), (G.output = O(n)), (B.output = G.output), (B.globstar = !0), Q(U)
                      continue
                    }
          ...
          828: (e, t, n) => {
            const o = n(622),
              ...
              l = (e, t, n = !1) => {
                ...
                var r
                if ('' === e || ('string' != typeof e && !o)) throw new TypeError('Expected pattern to be a non-empty string')
                const a = t || {},
                  i = s.isWindows(t),
            ...
            ;(l.test = (e, t, n, { glob: o, posix: r } = {}) => {
              ...
              (l.matchBase = (e, t, n, r = s.isWindows(n)) => (t instanceof RegExp ? t : l.makeRe(t, n)).test(o.basename(e))),
          ...
          321: (e, t, n) => {
            ...
            e.exports = (e, t) => {
              ...
              k > 0 && ((Q = H.slice(0, k)), (H = H.slice(k)), (L -= k)),
                W && !0 === N && L > 0 ? ((W = H.slice(0, L)), (X = H.slice(L))) : !0 === N ? ((W = ''), (X = H)) : (W = H),
              ...
              if ((!0 === n.tokens && ((q.maxDepth = 0), m(S) || v.push(j), (q.tokens = v)), !0 === n.parts || !0 === n.tokens)) {
                let t
                ...
                if (t && t + 1 < e.length) {
                  const o = e.slice(t + 1)
                  x.push(o), n.tokens && ((v[v.length - 1].value = o), _(v[v.length - 1]), (q.maxDepth += v[v.length - 1].depth))
                }
          ...
          598: (e, t, n) => {
            const o = n(622),
              ...
              { REGEX_BACKSLASH: a, REGEX_REMOVE_BACKSLASH: s, REGEX_SPECIAL_CHARS: i, REGEX_SPECIAL_CHARS_GLOBAL: l } = n(86)
          ...
          615: (e, t, n) => {
            ...
            const o = n(761),
              r = (e, t, n) => {
                ...
                let l = e + ':' + t + '=' + String(a.relaxZeros) + String(a.shorthand) + String(a.capture) + String(a.wrap)
            ...
            function s(e, t, n, o) {
              ...
              for (let e = 0; e < s.length; e++) {
                ...
                n.isPadded || !r || r.pattern !== l.pattern
                  ? (n.isPadded && (p = g(t, n, o)), (l.string = p + l.pattern + d(l.count)), i.push(l), (u = t + 1), (r = l))
