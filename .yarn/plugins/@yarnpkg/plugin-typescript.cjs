      ...
      var e = {
          958: (e, t, r) => {
            ...
            const d = (e) => {
                const t = {
                  async send(t) {
                    try {
                      const r = await s.httpUtils.request(t.url, t.data || null, { configuration: e, headers: t.headers })
                  ...
                  afterWorkspaceDependencyAddition: async (e, t, r, o) => {
                    ...
                    if (
                      !(await (async (e, t) => {
                        ...
                        try {
                          return (
                            'definitely-typed' ===
                            (null === (r = (await o.getObject(a, { attributesToRetrieve: ['types'] })).types) || void 0 === r
                              ? void 0
                              : r.ts)
                          )
                        } catch (e) {
                    ...
                    const g = `${a.suggestUtils.Modifier.CARET}${y.major}`,
                      ...
                      f = s.miscUtils.mapAndFind(i.workspaces, (e) => {
                        var t, a
                        const o =
                            null === (t = e.manifest.dependencies.get(r.identHash)) || void 0 === t ? void 0 : t.descriptorHash,
                          n =
                            null === (a = e.manifest.devDependencies.get(r.identHash)) || void 0 === a ? void 0 : a.descriptorHash
          ...
          223: (e, t, r) => {
            ...
            const n = (e) => {
              ...
              c = (e) => (t, r) => e.transporter.write({ method: o.N.Delete, path: (0, s.encode)('2/abtests/%s', t) }, r),
              ...
              u = (e) => (t, r) => e.transporter.write({ method: o.N.Post, path: (0, s.encode)('2/abtests/%s/stop', t) }, r)
          },
          757: (e, t, r) => {
            'use strict'
            function s(e, t, r) {
          ...
          103: (e, t, r) => {
            ...
            const n = (e) => {
              ...
              c = (e) => (t, r) => e.transporter.write({ method: o.N.Post, path: '1/strategies/personalization', data: t }, r)
          },
          790: (e, t, r) => {
            'use strict'
            r.r(t),
            ...
            const p = (e) => (t, r) => {
              ...
              h = (e) => (t, r, s) =>
                e.transporter.write({ method: o.N.Post, path: '1/clusters/mapping/batch', data: { users: t, cluster: r } }, s),
              y = (e) => (t, r, a) =>
                (0, s.createWaitablePromise)(
                  ...
                  (r, s) => x(e)(t, { methods: { waitTask: De } }).waitTask(r.taskID, s),
                ),
              ...
              S = (e) => (t, r) => e.transporter.read({ method: o.N.Get, path: (0, s.encode)('1/clusters/mapping/%s', t) }, r),
              D = (e) => (t) => {
                const { retrieveMappings: r, ...s } = t || {}
                return (
                  !0 === r && (s.getClusters = !0), e.transporter.read({ method: o.N.Get, path: '1/clusters/mapping/pending' }, s)
                )
              },
              x =
                (e) =>
              ...
              k = (e) => (t, r) =>
                (0, s.createWaitablePromise)(
                  ...
                  (t, r) =>
                    Promise.all(
                      Object.keys(t.taskID).map((s) => x(e)(s, { methods: { waitTask: De } }).waitTask(t.taskID[s], r)),
                    ),
                ),
              U = (e) => (t, r) =>
              ...
              E = (e) => (t, r) =>
                Promise.all(
                  t.map((t) => {
                    ...
                    return x(e)(t.indexName, { methods: { searchForFacetValues: je } }).searchForFacetValues(s, a, { ...r, ...o })
                  }),
                ),
              M = (e) => (t, r) => {
              ...
              K = (e) => (t) =>
                i({
                  ...
                  request: (r) =>
                    e.transporter.read({ method: o.N.Post, path: (0, s.encode)('1/indexes/%s/browse', e.indexName), data: r }, t),
                }),
              B = (e) => (t) => {
                ...
                return i({
                  ...
                  request: (t) =>
                    ve(e)('', { ...r, ...t }).then((e) => ({ ...e, hits: e.hits.map((e) => (delete e._highlightResult, e)) })),
                })
              },
              z = (e) => (t) => {
                const r = { hitsPerPage: 1e3, ...t }
                return i({
                  ...
                  shouldStop: (e) => e.hits.length < r.hitsPerPage,
                  request: (t) =>
                    Ne(e)('', { ...r, ...t }).then((e) => ({ ...e, hits: e.hits.map((e) => (delete e._highlightResult, e)) })),
                })
              },
              V = (e) => (t, r, a) => {
                  ...
                  c = (s = 0) => {
                    ...
                    return 0 === a.length
                      ...
                      : H(e)(
                          ...
                          n,
                        ).then((e) => ((i.objectIDs = i.objectIDs.concat(e.objectIDs)), i.taskIDs.push(e.taskID), d++, c(d)))
                  }
                return (0, s.createWaitablePromise)(c(), (t, r) => Promise.all(t.taskIDs.map((t) => De(e)(t, r))))
              },
              $ = (e) => (t) =>
                (0, s.createWaitablePromise)(
              ...
              L = (e) => (t) => {
                ...
                return (
                  ...
                  (0, s.createWaitablePromise)(
                    e.transporter.write({ method: o.N.Post, path: (0, s.encode)('1/indexes/%s/rules/clear', e.indexName) }, i),
                    (t, r) => De(e)(t.taskID, r),
                  )
                )
              },
              Q = (e) => (t) => {
                ...
                return (
                  r && (i.queryParameters.forwardToReplicas = 1),
                  (0, s.createWaitablePromise)(
                    e.transporter.write({ method: o.N.Post, path: (0, s.encode)('1/indexes/%s/synonyms/clear', e.indexName) }, i),
                    (t, r) => De(e)(t.taskID, r),
                  )
                )
              },
              ...
              Z = (e) => (t, r) => {
                ...
                return (
                  ...
                  (0, s.createWaitablePromise)(
                    e.transporter.write({ method: o.N.Delete, path: (0, s.encode)('1/indexes/%s/rules/%s', e.indexName, t) }, c),
                    (t, r) => De(e)(t.taskID, r),
                  )
                )
              },
              ...
              re = (e) => (t, r) => {
                ...
                const i = () =>
                  Oe(e)(s || '', { ...o, page: n }).then((e) => {
                    ...
                    if ((n++, !1 === a || n >= e.nbPages)) throw { name: 'ObjectNotFoundError', message: 'Object not found.' }
                    return i()
                  })
                return i()
              },
              ...
              oe = (e) => (t, r) => {
                const { attributesToRetrieve: s, ...a } = r || {},
                  n = t.map((t) => ({ indexName: e.indexName, objectID: t, ...(s ? { attributesToRetrieve: s } : {}) }))
                return e.transporter.read({ method: o.N.Post, path: '1/indexes/*/objects', data: { requests: n } }, a)
              },
              ne = (e) => (t, r) =>
                e.transporter.read({ method: o.N.Get, path: (0, s.encode)('1/indexes/%s/rules/%s', e.indexName, t) }, r),
              ie = (e) => (t) =>
                e.transporter.read(
                  { method: o.N.Get, path: (0, s.encode)('1/indexes/%s/settings', e.indexName), data: { getVersion: 2 } },
                  t,
                ),
              ce = (e) => (t, r) =>
                e.transporter.read({ method: o.N.Get, path: (0, s.encode)('1/indexes/%s/synonyms/%s', e.indexName, t) }, r),
              de = (e) => (t, r) =>
                e.transporter.read(
              ...
              Oe = (e) => (t, r) =>
                e.transporter.read(
                  { method: o.N.Post, path: (0, s.encode)('1/indexes/%s/query', e.indexName), data: { query: t }, cacheable: !0 },
                  r,
                ),
              je = (e) => (t, r, a) =>
                e.transporter.read(
              ...
              ve = (e) => (t, r) =>
                e.transporter.read(
                  { method: o.N.Post, path: (0, s.encode)('1/indexes/%s/rules/search', e.indexName), data: { query: t } },
                  r,
                ),
              Ne = (e) => (t, r) =>
                e.transporter.read(
                  { method: o.N.Post, path: (0, s.encode)('1/indexes/%s/synonyms/search', e.indexName), data: { query: t } },
                  r,
                ),
              Se = (e) => (t, r) => {
                const { forwardToReplicas: n, ...i } = r || {},
              ...
              De = (e) => (t, r) =>
                (0, s.createRetryablePromise)((s) => de(e)(t, r).then((e) => ('published' !== e.status ? s() : void 0))),
              xe = {
                AddObject: 'addObject',
                Analytics: 'analytics',
                Browser: 'browse',
          ...
          45: (e, t, r) => {
            'use strict'
            function s() {
              return { debug: (e, t) => Promise.resolve(), info: (e, t) => Promise.resolve(), error: (e, t) => Promise.resolve() }
            }
                  ...
                  new Promise((n) => {
                    const i = (0, o.parse)(e.url),
                      ...
                      l = ('https:' === i.protocol ? a : s).request(d, (e) => {
                        ...
                        e.on('data', (e) => (t += e)),
                          e.on('end', () => {
                            clearTimeout(p), clearTimeout(m), n({ status: e.statusCode || 0, content: t, isTimedOut: !1 })
                          })
                      }),
                      u = (e, t) =>
                        setTimeout(() => {
          ...
          858: (e, t, r) => {
            ...
            function u(e, t, r, a) {
              ...
              })(e.hostsCache, t).then((e) => S([...e.statelessHosts].reverse(), e.getTimeout))
            }
            function p(e) {
              const {
                  hostsCache: t,
